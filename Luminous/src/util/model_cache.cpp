...
namespace luminous {
    ...
    inline namespace utility {
        ...
        std::vector<shared_ptr<Mesh>> ModelCache::load_meshes(const std::string &path, uint subdiv_level) {
        ...
        const std::vector<shared_ptr<Mesh>>& ModelCache::get_meshes(const std::string &path, uint subdiv_level) {
            auto self = instance();
