...
#define While(...) ::luminous::compute::dsl::WhileStmtBuilder{__VA_ARGS__} << [&]()
...
#define Do ::luminous::compute::dsl::DoWhileStmtBuilder{} << [&]()
#define When(...) << ::luminous::compute::dsl::detail::extract_variable(__VA_ARGS__)
