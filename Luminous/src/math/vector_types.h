...
#define MAKE_VECTOR_MAKE_TYPE4(type)                                                                                        \
    ...
    template<typename U>                                                                                                    \
    [[nodiscard]] constexpr auto make_##type##4(Vector<U, 4, false> v) noexcept {                                           \
...
// For boolN
[[nodiscard]] constexpr auto operator!(bool2 v) noexcept {
    return make_bool2(!v.x, !v.y);
}
[[nodiscard]] constexpr auto operator!(bool3 v) noexcept {
    return make_bool3(!v.x, !v.y, !v.z);
}
[[nodiscard]] constexpr auto operator!(bool4 v) noexcept {
    return make_bool4(!v.x, !v.y, !v.z, !v.w);
}
[[nodiscard]] constexpr auto operator||(bool2 lhs, bool2 rhs) noexcept {
    return make_bool2(lhs.x || rhs.x, lhs.y || rhs.y);
}
[[nodiscard]] constexpr auto operator||(bool3 lhs, bool3 rhs) noexcept {
    return make_bool3(lhs.x || rhs.x, lhs.y || rhs.y, lhs.z || rhs.z);
}
[[nodiscard]] constexpr auto operator||(bool4 lhs, bool4 rhs) noexcept {
...
[[nodiscard]] constexpr bool any(bool2 v) noexcept { 
    return v.x || v.y; 
}

[[nodiscard]] constexpr bool any(bool3 v) noexcept { 
    return v.x || v.y || v.z; 
}

[[nodiscard]] constexpr bool any(bool4 v) noexcept { 
    return v.x || v.y || v.z || v.w; 
}

[[nodiscard]] constexpr bool all(bool2 v) noexcept { 
    return v.x && v.y; 
}

[[nodiscard]] constexpr bool all(bool3 v) noexcept { 
    return v.x && v.y && v.z; 
}

[[nodiscard]] constexpr bool all(bool4 v) noexcept { 
    return v.x && v.y && v.z && v.w; 
}

[[nodiscard]] constexpr bool none(bool2 v) noexcept { 
    return !any(v); 
}

[[nodiscard]] constexpr bool none(bool3 v) noexcept { 
    return !any(v); 
}

[[nodiscard]] constexpr bool none(bool4 v) noexcept { 
    return !any(v); 
}

}}// namespace luminous::vector
