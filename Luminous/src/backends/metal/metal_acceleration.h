...
//
//    public:
//        MetalAcceleration(MPSInstanceAccelerationStructure *as,
//                          MPSRayIntersector *closest_its,
//                          MPSRayIntersector *any_its) noexcept
//                : _as{as},
//                _closest_intersector{closest_its},
//                _any_intersector{any_its} {
//
//        }
//    };
}